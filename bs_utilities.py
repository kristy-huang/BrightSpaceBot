...
class BSUtilities():
    ...
    def find_course_ID(self, course_name_str):
        ...
        for course in enrolled_courses:
            ...
            course_name_str = course_name_str.replace(' ', '')
    ...
    def find_upcoming_disc_dates(self, add_days, discussion_dates):
        ...
        for discussion in discussion_dates:
            if discussion[0] is not None and discussion[1] is not None and discussion[1][:-1]:
                name = discussion[0]
    ...
    def get_sorted_grades(self):
        ...
        grades_frac = []
            ...
            # print(f"name: {name}, grade string: {grade_string},grade: {fraction_grade}\n")
