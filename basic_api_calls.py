...
def testing_webdriver():
    # Makes the browser not pop up
    options = webdriver.ChromeOptions()
    options.add_argument('--headless')

    # Basically, this controls all the movements automatically
    path = os.path.abspath(webdriver.__file__)
    driver = webdriver.Chrome(executable_path="/Users/raveena/Downloads/chromedriver", options=options)
...
def authenticate():
    ...
    # Basically, this controls all the movements automatically
    path = os.path.abspath(webdriver.__file__)
    driver = webdriver.Chrome(executable_path="/Users/raveena/Downloads/chromedriver")
    ...
    x = driver.find_element_by_id("panel-search-my-enrollments")
    print(x)
    # driver.find_element_by_xpath("/html/body/div[2]/div/div[1]/p[2]/a[1]").click()
    # time.sleep(3)
    # driver.get("https://purdue.brightspace.com/d2l/le/content/343395/Home")
...
def get_file(driver):
    x = driver.find_elements_by_class_name("panel-search-my-enrollments")
    print(x)
